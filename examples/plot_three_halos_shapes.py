...
# three lenses
m200 = [1e13, 1e12, 1e13] # halo masses

# lens model: NFW halo + point mass at the center
lens1 = wl_lens_models.NFWPoint(z=zd, m200=m200[0], mstar=1e11, c200=5.)
lens2 = wl_lens_models.NFWPoint(z=zd, m200=m200[1], mstar=1e11, c200=5.)
lens3 = wl_lens_models.NFWPoint(z=zd, m200=m200[2], mstar=1e11, c200=5.)
...
pylab.yticks(())
pylab.axis('off')
pylab.savefig('threelens_shapes_enhanced_circular_plot.png')
pylab.show()
